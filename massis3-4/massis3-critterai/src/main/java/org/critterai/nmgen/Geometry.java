...
public final class Geometry {
	 ...
	 * library, they will slowly be migrated here as needed for easier unit
	 * testing.
	 * 
	 */
	 ...
	 */
	public static float getPointSegmentDistanceSq(final int px, final int py,
	...
	public static float getPointSegmentDistanceSq(final float px,
			final float py, final float pz, final float ax, final float ay,
			final float az, final float bx, final float by, final float bz)
	{
		...
		final float u = (deltaABx * deltaAPx
				+ deltaABy * deltaAPy
	 ...
	 *         manner.
	 */
	public static boolean segmentsIntersect(final int ax, final int ay,
