...
public class Plane extends com.jme3.math.Plane {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1558076907784562698L;
	 ...
	 * @return
	 */
	public float solveForX(final float y, final float z)
	{
		// Ax + By + Cz + D = 0
		// Ax = -(By + Cz + D)
		// x = -(By + Cz + D)/A
	 ...
	 * @return
	 */
	public float solveForY(final float x, final float z)
	{
		// Ax + By + Cz + D = 0
		// By = -(Ax + Cz + D)
		// y = -(Ax + Cz + D)/B
	 ...
	 * @return
	 */
	public float solveForZ(final float x, final float y)
	{
		// Ax + By + Cz + D = 0
		// Cz = -(Ax + By + D)
		// z = -(Ax + By + D)/C
