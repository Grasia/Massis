...
public class RVO2Agent {
	public final List<Pair<Double, RVO2Agent>> agentNeighbors = new ArrayList<>();
	public final List<Pair<Double, RVO2Obstacle>> obstacleNeighbors = new ArrayList<>();
	public final List<Line> lines = new ArrayList<>();
    public Vector2D position = Vector2D.ZERO;
    public Vector2D preferredVelocity = Vector2D.ZERO;
    public Vector2D velocity = Vector2D.ZERO;
    public int id = 0;
    public  int maxNeighbors = 0;
    public  double maxSpeed = 0.0;
    public  double neighborDistance = 0.0;
    public  double radius = 0.0;
    public  double timeHorizonAgents = 0.0;
    public  double timeHorizonObstacles = 0.0;
     ...
     */
    public void computeNeighbors(AgentNeighboursFinder kdTree) {
    	//TODO remove from here or smth
        ...
        if (maxNeighbors > 0) {
           kdTree.computeAgentNeighbors(this, neighborDistance * neighborDistance);
        }
    }
    ...
    public  void computeNewVelocity(float timeStep) {
        ...
        for (final Pair<Double, RVO2Obstacle> obstacleNeighbor : obstacleNeighbors) {
            RVO2Obstacle obstacle1 = obstacleNeighbor.getSecond();
            RVO2Obstacle obstacle2 = obstacle1.next;
        ...
        for (final Pair<Double, RVO2Agent> agentNeighbor : agentNeighbors) {
            final RVO2Agent other = agentNeighbor.getSecond();
     ...
     */
    public double insertAgentNeighbor(RVO2Agent agent, double rangeSq) {
        if (this != agent) {
     ...
     * @param rangeSq  The squared range around this agent.
     */
    public void insertObstacleNeighbor(RVO2Obstacle obstacle, double rangeSq) {
        final RVO2Obstacle nextObstacle = obstacle.next;
    ...
    public void updateVelocity(float tpf) {
      ...
      //  position = position.add(tpf, velocity);
    }
