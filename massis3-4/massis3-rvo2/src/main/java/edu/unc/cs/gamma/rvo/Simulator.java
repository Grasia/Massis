...
public class Simulator {
    ...
    final List<RVO2Agent> agents = new ArrayList<>();
    final List<RVO2Obstacle> obstacles = new ArrayList<>();
    final RVO2KdTree kdTree = new RVO2KdTree();
    double timeStep = 0.0;

    private RVO2Agent defaultAgent = null;
    ...
    public int addObstacle(List<Vector2D> vertices) {
        ...
        for (int vertexNo = 0; vertexNo < vertices.size(); vertexNo++) {
            final RVO2Obstacle obstacle = new RVO2Obstacle();
...
//
//        for (final RVO2Agent agent : agents) {
//            agent.computeNeighbors();
//            agent.computeNewVelocity();
//        }
//
//        agents.forEach(RVO2Agent::update);
//
//        globalTime += timeStep;
//
//        return globalTime;
